...
function Home() {
 ...
 return (
   ...
   <Container className="wrapper">
    ...
    <Carousel>
      <Carousel.Item>
          <img src="./img/Banner-PPAL.webp" className="d-block w-100 carousel-img" alt="nocargojeje"></img>
      </Carousel.Item>
      <Carousel.Item>
          <img src="./img/Modyo-WEB-Banner-Pricipal-1792X4.webp" className="d-block w-100 carousel-img" alt="nocargojeje"></img>
      </Carousel.Item>
      <Carousel.Item>
